...
Additional KPI Metrics: Assess how Average Sales, Number of Items, and Ratings vary with fat content.

Chart Type: 🟡 Donut Chart.

4.2 Total Sales by Item Type

Objective: Identify performance of different item categories (e.g., Fruits, Snack Foods, Dairy).

Additional KPI Metrics: Analyze Average Sales, Number of Items, and Ratings for each item type.

Chart Type: 📊 Bar Chart.

4.3 Fat Content by Outlet for Total Sales

Objective: Compare total sales across different outlet tiers (Tier 1, Tier 2, Tier 3) segmented by fat content.

Additional KPI Metrics: Assess how other KPIs vary across outlets and fat categories.

Chart Type: 🧱 Stacked Column Chart.

4.4 Total Sales by Outlet Establishment

Objective: Evaluate how the age/type of outlet establishment influences total sales over the years.
...
Understand customer preferences through ratings and sales data.

Support strategic decisions using clear and actionable insights.
